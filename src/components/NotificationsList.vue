<template>
  <drop-down tag="li">
    ...
    <div v-for="notif in notifs" :key="notif._id" :class="{ read: notif.read, 'dropdown-item': true }" >
      ...
      <a style="float:right"><i class="nc-icon nc-simple-remove" @click="deleteNotification(notif)"></i></a>
    </div>
  </drop-down>
</template>
